...
const api=process.env.REACT_APP_API;
 const Userdetails=(props)=>{
	...
	const picurl= "https://mernecombucket.s3.amazonaws.com/dAInx6qFL-nopic2.jpg";
  ...
  <div><span style={{marginBottom:"20px",display:"block"}}>CHANGE PROFILE PICTURE</span><input type="file" name="pic"  onChange={handlepic} /></div> */
	...
	<div><img  style={{position:"relative",maxHeight:"100px",maxWidth:"100px",borderRadius:"50%"}} src={picurl} /> </div>
